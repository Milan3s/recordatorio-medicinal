...
<head>
    ...
    <title>Detalle del Registro de Tensión</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <!-- Detalle del registro en estilo folio -->
    <div class="container my-5">
        <div class="folio">
            <h3 class="text-center mb-4">Detalle del Registro de Tensión</h3>
            <p><strong>Usuario:</strong> <?php echo htmlspecialchars($registro['usuario_nombre']); ?></p>
            <p><strong>Fecha:</strong> <?php echo htmlspecialchars($registro['fecha']); ?></p>
            <p><strong>Sistólica:</strong> <?php echo htmlspecialchars($registro['sistolica']); ?> mmHg</p>
            <p><strong>Diastólica:</strong> <?php echo htmlspecialchars($registro['diastolica']); ?> mmHg</p>
            <p><strong>Pulso:</strong> <?php echo htmlspecialchars($registro['pulso']); ?> BPM</p>
            <div class="text-center mt-4">
                <a href="ListadoTension.php" class="btn btn-primary"><i class="bi bi-arrow-left"></i> Volver al Listado</a>
            </div>
        </div>
    </div>
